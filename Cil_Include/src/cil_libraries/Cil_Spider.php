...
class Cil_Spider
{
	...
	public function __construct($config = array())
	{
        ...
        public function reset()
        {
                ...
                $this->_returntransfer  = 1;
                $this->_timeout         = 30;
                $this->_url             = NULL;
                $this->_user_agent      = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/33.0.1750.146 Safari/537.36 CI_Leedition Spider';
        }
	...
	public function set_http_header($http_headers = array())
	{
        ...
        /**
         * set http refer send to host
         * @param type $http_refer
         */
        public function set_http_referer($http_referer = '')
        {
         ...
         * set returntransfer
         * @access public
         * @param type $returntransfer
         * @return void
         */
        public function set_returntransfer($returntransfer = 1)
        {
                $this->_returntransfer = $returntransfer;
        }
        
        /**
         * set connection timeout, default 30 seconds, 0 to set unlimit
         * 
         * @access public
         * @param int $timeout
         * @return void
